...
BOOL FAR_Init(void)
{
	if(!(mh1 = (FARHEADER1*)_mikm_malloc(sizeof(FARHEADER1)))) return 0;
	if(!(mh2 = (FARHEADER2*)_mikm_malloc(sizeof(FARHEADER2)))) return 0;
	if(!(pat = (FARNOTE*)_mikm_malloc(256*16*4*sizeof(FARNOTE)))) return 0;
